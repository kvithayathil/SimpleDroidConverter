...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        CurrencyPairEntityDao.createTable(db, ifNotExists);
        ConversionItemDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        CurrencyEntityDao.dropTable(db, ifExists);
        CurrencyPairEntityDao.dropTable(db, ifExists);
        ConversionItemDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(CurrencyPairEntityDao.class);
        registerDaoClass(ConversionItemDao.class);
    }
